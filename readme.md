...
- **url_malicious.txt**: A text file containing a malicious URL, expected to be blocked.
...
## 5. Downloading url_malicious.txt
**Command:**
```sh
wget https://raw.githubusercontent.com/elysium-build/irapdemo/refs/heads/main/url_malicious.txt
``` 
**Log:**
```json
{"timestamp": "2025-12-01 22:37:21", "response_time": "52", "dns_response": "-", "client_ip": "10.*.*.*", "http_version": "1.1", "user_agent": "Wget/1.21.1", "request_method": "GET", "request_url": "https://raw.githubusercontent.com/elysium-build/irapdemo/refs/heads/main/url_malicious.txt", "content_type": "text/plain", "squid_cache_status": "TCP_MISS", "squid_hierarchy_status": "HIER_DIRECT", "response_code": "403", "response_size": "1107", "tls_version": "TLS/1.3", "tls_cipher": "TLS_AES_256_GCM_SHA384", "cert_errors": "-", "icap_blocking_time": "0"}
``` 
```sh
[root@epidplndmzXX irap]# wget https://raw.githubusercontent.com/elysium-build/irapdemo/refs/heads/main/url_malicious.txt
-2025-12-02 09:37:21--  https://raw.githubusercontent.com/elysium-build/irapdemo/refs/heads/main/url_malicious.txt
Resolving fpx.domainname.com (fpx.domainname.com)... 10.*.*.*
Connecting to fpx.domainname.com (fpx.domainname.com)|10.*.*.*|:portnumber... connected.
Proxy request sent, awaiting response... 403 Forbidden
2025-12-02 09:37:21 ERROR 403: Forbidden.
```
...
These tests confirm that ClamAV and the proxy setup successfully block malicious or suspicious files (EICAR test file , encrypted zip and url_malicious.txt), while allowing normal files to be downloaded. All logs above are shown exactly as captured during the tests.
